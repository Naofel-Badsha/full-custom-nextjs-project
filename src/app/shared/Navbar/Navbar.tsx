      ...
      >
        ...
        <div className="flex lg:hidden">
          ...
          >
            ...
            <Bars3Icon
              aria-hidden="true"
              className="size-8 bg-green-700 text-white cursor-pointer"
            />
          </button>
        </div>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <Link
            href="/singin"
            className="text-sm/6 font-semibold text-white bg-[#019a49] hover:bg-[#005224] px-5 py-2 rounded-full"
          >
            Log In
          </Link>
        </div>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Link
                  href="/"
                  className="text-sm/6 font-semibold rounded-lg flex items-center justify-between py-2 px-2 w-full text-gray-900 hover:bg-gray-50"
                >
                  Home
                </Link>
                {/*------------Dropdown-------1---------*/}
              ...
              <div className="py-6">
                <Link
                  href="/singin"
                  className="-mx-3 w-fit block text-base/7 font-semibold text-white bg-[#019a49] hover:bg-[#005224] px-5 py-2 rounded-full"
                >
                  Log in
                </Link>
              </div>
