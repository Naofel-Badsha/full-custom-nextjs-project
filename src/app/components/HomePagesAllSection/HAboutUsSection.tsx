...
const HAboutUsSection = () => {
  return (
    <section className="py-[100px] bg-white">
      <div className="max-w-7xl mx-auto lg:gap-14 px-6">
        <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex  gap-8 items-center justify-center">
              ...
              <div className="space-y-8 flex items-center">
                <div className="relative ">
                  ...
                  <div className="absolute top-[200px] lg:top-[250px] w-full">
                    <Image
          ...
          <div className="flex-1">
            <div className="space-y-5">
              ...
              <h2 className="text-[#1d1d1d] font-semibold text-[30px] lg:text-[42px] capitalize">
                Provide information about reading insurance, generate leads,
                policies.
              </h2>
              <p className="text-[16px] lg:text-[18px] font-light text-[#6d6d6d]">
              ...
              <p className="text-[16px] lg:text-[18px] font-light text-[#6d6d6d]">
                Nunc eget quam vel justo aliquam sagittis in sit amet lorem.
                Donec sem nisi, bibendum sed laoreet in, malesuada quis neque.
              </p>

              <div className="bg-[#E6F7EE] p-6 border-l-3 border-[#00863F]">
                <p className="text-[#1d1d1d] text-[16px] lg:text-[19px] font-semibold ">
                  A house is made of walls and beams; a home is built with love
                  and dreams. Protect both with insurance.
                </p>
              </div>

              <div className="flex flex-wrap items-center gap-10 border-b-1 border-gray-300 pb-8">
                {/*-------------1---------*/}
                <div className="flex items-center gap-1">
                  <FaWpforms className="bg-[#2A2A2A] p-2 text-4xl rounded-full text-[#00A04C]" />
                  <p className="text-[#1d1d1d] text-[15px] lg:text-[18px] font-medium">
                    Claim Form
                  </p>
                </div>
                {/*-------------2---------*/}
