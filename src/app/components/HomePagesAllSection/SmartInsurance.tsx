    ...
    <section className="py-[100px] bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-center justify-center">
          ...
          <div
            className="relative w-full p-6 md:p-10  bg-[#006b33] rounded-3xl overflow-hidden flex flex-col lg:flex-row"
            style={{
          ...
          >
            ...
            <div className="w-full  z-10 text-white">
              <span className="bg-white text-[#00a352] px-4 py-1.5 rounded-full text-sm font-medium mb-6 inline-block">
                Smart Insurance
              </span>

              <h1 className="text-[30px] lg:text-[42px] font-bold leading-12 mb-8">
            ...
            {/*----------Right Sidebar Card----------*/}
            <div className="w-full bg-[#222222] p-6 md:mt-10 lg:mt-0 rounded-2xl flex flex-col z-20">
              {/* Agent Header */}
